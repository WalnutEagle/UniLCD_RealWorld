...
from REAL_TIME_WORKING.communication.tcp.server import start_server, receive_data, send_response
from REAL_TIME_WORKING.power_stats.get_power import get_jetson_stats
...
def main():
    ...
    parser.add_argument('-s', '--model_path', default="/home/h2x/Desktop/IL_DATA_COLLECTION_ADWAIT/Main_script/09-15-2024/model.pth", type=str, help='Path to save your model')
