...
if __name__ == "__main__":
    ...
    parser.add_argument('-d', '--data_folder', default="/home/h2x/Desktop/REAL_TIME_WORKING/Today's Data/singlerun/10-03-2024", type=str, help='Path to your dataset')
    parser.add_argument('-m', '--model_path', default="/home/h2x/Desktop/REAL_TIME_WORKING/TrainedModels/singlerun.pth", type=str, help='Path to your Trained Model')
