...
def update_visualization():
    ...
    while True:
        ...
        plt.pause(0.05)  # Update the plot
...
def main():
    ...
    update_visualization()  # Start the visualization in the main thread
    ...
    for i in range(num_samples):
        ...
        current_mode = 'Cloud Mode' if mode_values[i] == 1 else 'Local Mode'
